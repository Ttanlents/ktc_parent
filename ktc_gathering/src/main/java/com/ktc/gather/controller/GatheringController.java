package com.ktc.gather.controller;
import com.ktc.gather.pojo.Gathering;
import com.ktc.gather.service.GatheringService;
...
return new Result(StatusCode.OK,true,"查询成功", gatheringService.findSearch(searchMap));
}
